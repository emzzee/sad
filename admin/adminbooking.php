...
<div class="row">
    <h4 class="mt-4 title" id="titlemanage">Manage Booking:</h4>
    <div class="col-md-12">
                                ...
                                <?php if ($users['status'] == 1) : ?>
                                    <div class="flex-container">
                                        <form action="admin-crud.php" method="POST">
                                            <input type="hidden" class="booking_id" name="booking_id" value="<?= htmlspecialchars($users['booking_id']) ?>">
                                            <button type="submit" name="approve_booking" class="btn btn-success see_details">Approve <i class='bx bx-detail'></i></button>
                                            <input type="hidden" class="user_id" name="user_id" value="<?= htmlspecialchars($users['booking_id']) ?>">
                                            <a href="admin-crud.php"> <button type="submit" name="decline_booking" class="btn btn-danger decline">Decline <i class='bx bx-x'></i></button></a>
                                        </form>
                                    </div>
                                <?php elseif ($users['status'] == 2 || $users['status'] == 3) : ?>
